    ...
    <div class="bukti-container">
                ...
                <div class="inp-uploads shadow">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="jumlah_bayar" onkeyup="rupiah(this)" class="form-control" id="floatingInput" placeholder="name@example.com">
            ...
            foreach($data["pemesanan"] as $p ) :
                ...
                <div class="desc-harga shadow">
                    ...
                    <p class="mb-0">Transfer Ke bank berikut :</p>
                    <div class="d-flex" style="align-items: center; gap: 20px;">
                        <img src="/image/logo-bca.png" width="150px" alt="">
                        <div>
                            <h4 class="m-0">2312234234233</h4>
                            <p class="m-0">Pt rahmatan travel</p>
                        </div>
                    </div>
