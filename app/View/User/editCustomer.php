    ...
    <div class="tambah-customer">
            ...
            <div class="container" id="step1">
             ...
             <div class="form-floating w-100 mb-3">
                    <input type="number" id="NIK" name="NIK" value="<?= $d->NIK ?>" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">NIK</label>
                </div>
                <div class="form-floating w-100 mb-3">
                    <input type="text" id="nama" name="nama" value="<?= $d->nama_customer ?>" class="form-control" id="floatingInput" placeholder="name@example.com">
                ...
                <div class="form-floating mb-3">
                    <input type="number" id="no_telp" value="<?= $d->no_telp ?>" name="no_telp" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Nomor Telepon</label>
                </div>
                <div class="d-flex" style="gap: 10px;">
                <div class="form-floating w-100 mb-3">
                    <input type="text" id="lahir" name="tempat_lahir" value="<?= $d->tempat_lahir ?>" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Tempat Lahir</label>
                </div>
                <div class="form-floating w-100 mb-3">
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?= $d->tanggal_lahir ?>" class="form-control" id="floatingPassword" placeholder="Password">
                ...
                <div class="form-floating mb-3">
                    <textarea id="alamat" name="alamat" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                        style="height: 100px"><?= $d->alamat ?></textarea>
                    <label for="floatingTextarea2">Alamat</label>
                </div>
                <div class="d-flex" style="gap: 10px;">
             <div class="form-floating w-100 mb-3">
                    <input type="text" id="pekerjaan" name="pekerjaan" value="<?= $d->pekerjaan ?>" class="form-control" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Pekerjaan</label>

                </div>
                <div class="form-floating w-100 mb-3">
                    <input type="text" id="ukuran_baju" value="<?= $d->ukuran_baju ?>" name="ukuran_baju" class="form-control" id="floatingInput" placeholder="name@example.com">
                    <label for="floatingInput">Ukuran Baju</label>
                </div>
             </div>
             <label for="">Foto</label>
             <img id="outputCustomer" width="200px" class="m-1 rounded shadow" src="/uploads/foto_customer/<?= $d->foto ?>"  alt="">
            ...
            <div class="form-floating mb-3 w-100">
                    <input type="number" class="form-control" value="<?= $d->nomor_pasport ?>" name="nomor_pasport" id="floatingPassword" placeholder="Password">
                ...
                <div class="form-floating mb-3 w-100">
                    <input type="text" class="form-control" name="nama_pasport" value="<?= $d->nama_pasport ?>" id="floatingInput" placeholder="name@example.com">
             ...
             <div class="form-floating mb-3 w-100">
                 <input type="text" value="<?= $d->tempat_penerbitan ?>" name="tempat_penerbitan" class="form-control" id="floatingPassword" placeholder="Password">
             ...
             <div class="form-floating mb-3 w-100">
                 <input type="date" name="tanggal_penerbitan" value="<?= $d->tgl_penerbitan ?>" class="form-control" id="floatingPassword" placeholder="Password">
            ...
            <img id="outputPasport" width="200px" class="m-1 rounded shadow" src="/uploads/foto_paspor/<?= $d->foto_pasport ?>"  alt="">
                ...
                <img id="outputPasport2" width="200px" class="m-1 rounded shadow" src="/uploads/foto_paspor2/<?= $d->foto_pasport_hal2 ?>"  alt="">
                    <div class="input-group">
            ...
            <img id="outputKtp" width="200px" class="m-1 rounded shadow" src="/uploads/foto_ktp/<?= $d->foto_ktp ?>"  alt="">
                    <div class="input-group">
                ...
                <img id="outputKk" width="200px" class="m-1 rounded shadow" src="/uploads/foto_paspor/<?= $d->foto_pasport ?>"  alt="">
                    <div class="input-group">
        ...
        <div class="d-flex" style="gap: 10px;">
            ...
            <img id="outputRekening" width="200px" class="m-1 rounded shadow" src="/uploads/foto_rekening/<?= $d->foto_rekening ?>"  alt="">
                    <div class="input-group">
                ...
                <img id="outputAkte" width="200px" class="m-1 rounded shadow" src="/uploads/foto_akte/<?= $d->foto_akte_kelahiran ?>" alt="">
                    <div class="input-group">
