                ...
                <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <select id="sts" name="status" class="form-select">
                                <option <?= ($d['status_status'] == "Belum Berangkat") ? 'selected' : '' ?> value="Belum Berangkat">Belum Berangkat</option>
                                <option <?= ($d['status_status'] == "Sedang Berangkat") ? 'selected' : '' ?> value="Sedang Berangkat">Sedang Berangkat</option>
                                <option <?= ($d['status_status'] == "Selesai Berangkat") ? 'selected' : '' ?> value="Selesai Berangkat">Selesai Berangkat</option>
                          </select>
                        </div>
